  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600 p-5">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-10">
        ...
        {/* Social buttons — hàng ngang */}
        <div className="grid grid-cols-2 gap-3">
          <button
            onClick={() => alert("Tính năng đăng nhập Google sẽ được cập nhật sau!")}
            className="flex items-center justify-center gap-2.5 py-3 border-2 border-gray-200 rounded-xl text-sm font-semibold text-gray-600 hover:border-blue-400 hover:bg-gray-50 transition-all"
          >
          ...
          <button
            onClick={() => alert("Tính năng đăng nhập Github sẽ được cập nhật sau!")}
            className="flex items-center justify-center gap-2.5 py-3 border-2 border-gray-200 rounded-xl text-sm font-semibold text-gray-600 hover:border-gray-800 hover:bg-gray-50 transition-all"
          >
